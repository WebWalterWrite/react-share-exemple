...
import { FacebookShare, LinkedinShare, PinterestShare } from '../social-share/SocialShare';
      ...
      <Preview>
        ...
        <Infos>
          ...
          <p itemProp="director">
            ...
            avec{" "}
            <span role="img" aria-label="heart">❤️</span> par {post.author} le {post.createdAt}</p>
